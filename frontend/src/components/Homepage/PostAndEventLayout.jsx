...
import CreateEventForm from "../Events/CreateEventForm";  // Assuming this is the path to your CreateEventForm component
import Newsfeed from "../../pages/Newsfeed";  // Assuming this is the path to your Newsfeed component
import EventList from "../Events/EventList";  // Assuming this is the path to your EventList component

const PostAndEventLayout = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="flex justify-between p-6">
        ...
        <div className="-mt-30 md:-mt-24"><Newsfeed /></div>
...
export default PostAndEventLayout;
